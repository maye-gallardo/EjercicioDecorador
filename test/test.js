...
describe('Decorator', function () {
  ...
  it('un arco con decorador de fuego deberia tener un daño de 20', function () {
    let arco = new Arco();
    arco = new Fuego(arco);
  ...
  it('un arco con decoradores de madera y fuego deberia tener un daño de 25', function () {
    let arco = new Arco();
    arco = new Madera(arco);
    arco = new Fuego(arco);
  ...
  it('un arco con los tres decoradores deberia tener un daño de 35', function () {
    let arco = new Arco();
    arco = new Madera(arco);
    arco = new Hierro(arco);
    arco = new Fuego(arco);
  ...
  it('una espada con decorador de fuego deberia tener un daño de 25', function () {
    let espada = new Espada();
